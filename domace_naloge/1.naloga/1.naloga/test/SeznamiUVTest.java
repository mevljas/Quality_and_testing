...
public class SeznamiUVTest {
    ...
    public void testCommandIncorrect() {
        ...
        assertEquals("Error: invalid command",
                uv.processInput("command"));
    }

    @Test
    public void testCommandWithoutUse() {
        assertEquals("Error: data structure is not selected",
    ...
    public void testAsListMultiple() {
        ...
        uv.processInput("add Test2");
        uv.processInput("add Test3");
        String list = uv.processInput("asList");
